...
//       borderRightColor: Color.grey400}}/>
// }

// const LongArrowLeft = ({n}) => {
//
//   let arrows = _.map(_.range(1,n), (i) => {
//     return <ArrowLeft key={i}/>
//   })
//
...
// }
//
// const LongArrowRight = ({n}) => {
//
//   let arrows = _.map(_.range(1,n), (i) => {
//     return <ArrowRight key={i}/>
//   })
//
//   return <div style={{display: 'inline-block'}}>
//     {arrows}
  ...
  render(){
    ...
    const eventElements = events.map((event, key) => {
      ...
      const arrow = event.get('type') === 'in' ?
        ...
        <LongArrowRight n={15} color={Color.red400}/>
